...
<template>
  <div>
    ...
    <div class="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap sm:gap-2">
      <button
        type="button"
        :class="[timerBtnClass, 'bg-emerald-700 !text-white hover:bg-emerald-600']"
        :disabled="
      ...
      <button
        type="button"
        :class="[timerBtnClass, 'bg-amber-700 !text-white hover:bg-amber-600']"
      ...
      <button
        type="button"
        :class="[timerBtnClass, 'bg-sky-700 !text-white hover:bg-sky-600']"
      ...
      <button
        type="button"
        :class="[timerBtnClass, 'bg-slate-600 !text-white hover:bg-slate-500']"
        :disabled="
          !canEdit
            || (
              match.status !== 'LIVE'
      ...
      <button
        type="button"
        class="col-span-2 min-h-[44px] rounded-lg bg-rose-900 px-3 py-2.5 text-sm !text-white hover:bg-rose-950 disabled:opacity-40 sm:col-span-1 sm:min-h-0 sm:py-1.5"
        :disabled="!canEdit"
