...
<template>
  ...
  <div v-else class="space-y-6 sm:space-y-8">
    <div class="min-w-0">
      ...
      >
        <ol class="flex flex-wrap items-center gap-1">
          ...
          <li class="break-words font-medium text-slate-600">
            {{ tournament.name }}
          </li>
        </ol>
      </nav>
      <h1
        class="break-words font-display text-xl font-semibold text-slate-900 sm:text-2xl"
      >
        {{ tournament.name }}
      </h1>
    ...
    <nav
      class="-mx-1 flex gap-4 border-b border-slate-200 px-1 sm:gap-8"
